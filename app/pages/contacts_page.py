...
class AddContactDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("הוסף איש קשר")
        ...
        self.name_input.setPlaceholderText("שם איש הקשר")
        form.addRow("שם:", self.name_input)

        self.number_input = QLineEdit()
        self.number_input.setPlaceholderText("מספר טלפון")
        self.number_input.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        form.addRow("מספר:", self.number_input)
...
class ContactsPage(QWidget):
    ...
    def _build(self):
        ...
        self.search_input.setPlaceholderText("🔍 חיפוש...")
        ...
        self.btn_import = QPushButton("📁 ייבא CSV")
    ...
    def _add_contact_to_list(self, number: str, name: str):
        ...
        widget = ContactItem(number, name)
